jQuery(document).ready(function(){
  ...
  if (typeof $( "#is_houseplant" )[0].attributes.value != 'undefined') {
    var value = $( "#is_houseplant" )[0].attributes.value.value;
    if (value == "t") {
      var b = $( "#is_houseplant_true").addClass("ui-selected");
    } else if (value == "f") {
  ...
  $( "#is_houseplant_selectable" ).selectable({
    stop: function() {
      $( ".ui-selected", this ).each(function() {
        ...
        var index = $( "#is_houseplant_selectable li" ).index( this );
        $('input[id=is_houseplant]').val(houseplantOptions[index]);
      });
    }
  });
  ...
  $("#plant_last_watering").datepicker({dateFormat: 'yy-mm-dd'});
  $("#plant_next_watering").datepicker({dateFormat: 'yy-mm-dd'});
